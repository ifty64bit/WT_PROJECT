        ...
        <table class="tab" style="width:100%">
            ...
            <tr>
                <form action="" method="post">
                    <?php echo $res['status']=='Blocked'? "<td colspan='2'><input name='ac' class='btn pass' type='submit' value='Active'></td>" : "<td colspan='2'><input name='bk' class='btn wrn' type='submit' value='Block'></td>" ?>
                </form>
            </tr>
